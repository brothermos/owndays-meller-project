    ...
    <footer className="bg-black text-[#ff6723]">
        ...
        <div className="border-y border-[#ff6723]">
          <div className="mx-auto grid max-w-[1440px] grid-cols-[64.7222%_35.2778%]">
            <div className="border-r border-[#ff6723] px-12 py-14">
              <nav className="flex flex-col gap-4 text-[31px] font-semibold tracking-wide">
                {NAV_ITEMS.map((item) => (
            ...
            <div className="flex flex-col items-center justify-center px-12 py-14">
              <div className="flex items-center gap-4">
                <Image
                  ...
                  aria-hidden="true"
                />
                <span className="text-[34px] font-semibold tracking-wide">
                  ONLINE STORE
                </span>
              </div>
              <div className="ml-8 flex items-center gap-2 text-[21px] font-semibold tracking-wide">
      ...
      <div className="mx-auto max-w-[720px] pb-8 lg:hidden">
        <div>
          <nav className="border-b-2 border-t-4 border-[#ff6723]">
            {NAV_ITEMS.map((item) => (
              <a
                key={item.label}
                href={item.href}
                className="flex items-center justify-between border-b-2 border-[#ff6723] px-[30px] py-7 font-semibold tracking-wide last:border-b-0"
              >
          ...
          <div className="flex items-center justify-between border-b border-[#ff6723] px-[30px] py-9">
            ...
            <div className="flex items-center text-xs gap-2 font-semibold tracking-wide">
              <span>OWNDAYS.COM</span>
              <Image
                src="/svg/copy_icon.svg"
                alt=""
          ...
          <div className="border-b border-[#ff6723] px-[30px] py-8">
            ...
            <Link href="#" aria-label="Instagram" className="mt-10 inline-flex">
              <Image
                src="/svg/instagram_icon.svg"
                alt=""
                width={34}
